...
public function boolean of_carregar_detalhes_pedido (datastore ads_pedido, long al_idpedido)
...
public function boolean of_carregar_detalhes_pedido (datastore ads_pedido, long al_idpedido);// Fun$$HEX2$$e700e300$$ENDHEX$$o para carregar os detalhes do pedido
...
For li_For = 1 To ads_Pedido.RowCount()
	...
	li_Resultado = of_Atualizar_Total_Pedido(ads_Pedido.GetItemNumber(li_For, "idpedido"), lde_PrecoFinal)
